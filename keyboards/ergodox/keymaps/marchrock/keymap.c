...
[QWRT] = KEYMAP(
        ...
        LALT(LCTL(KC_DEL)), KC_NO,    KC_NO,   KC_NO,   KC_NO,
                                                                 KC_LALT, KC_LGUI,
                                                                          KC_HOME,
        ...
        // right hand
             ...
             KC_QUOT, KC_N,    KC_M,   KC_COMM, KC_DOT,  KC_SLSH, MO(SYMB),
                               KC_NO,  KC_NO,   KC_NO,   KC_NO,   TG(DVRK),
             KC_LGUI, KC_LCTL,
             KC_PGUP,
             KC_PGDN, KC_LALT, KC_BSPACE
    ),
...
[DVRK] = KEYMAP(
       // left hand
       KC_NO,               KC_1,       KC_2,       KC_3,       KC_4,   KC_5,   KC_GRV,
       KC_ESC,              KC_QUOT,    KC_COMM,    KC_DOT,     KC_P,   KC_Y,   KC_LBRC,
       ...
       LALT(LCTL(KC_DEL)),  KC_NO,      KC_NO,      KC_NO,      KC_NO,
                                                                ...
                                                                KC_SPC, KC_TAB, KC_END,
       // right hand
       KC_NO,   KC_6,   KC_7,   KC_8,   KC_9,   KC_0,   KC_DELETE,
       KC_RBRC, KC_F,   KC_G,   KC_C,   KC_R,   KC_L,   KC_BSLS,
                KC_D,   KC_H,   KC_T,   KC_N,   KC_S,   KC_ENT,
       KC_EQL,  KC_B,   KC_M,   KC_W,   KC_V,   KC_Z,   MO(SYMB),
...
[SYMB] = KEYMAP(
       ...
       KC_TRNS, KC_SLSH,  KC_LBRC,    KC_RBRC,  KC_NO,  KC_NO,      KC_NO,
       KC_TRNS, KC_NO,    KC_NO,      KC_NO,    KC_NO,  KC_NO,
       KC_TRNS, KC_MINS,  KC_EQL,     KC_NO,    KC_NO,  KC_NO,      KC_NO,
    ...
    // right hand
       ...
       KC_NO,   KC_NO,  KC_NO,  KC_NO,      KC_NO,      KC_NO,      MO(SYMB),
                        KC_NO,  KC_NO,      KC_NO,      KC_NO,      KC_NO,
       KC_TRNS, KC_TRNS,
       KC_TRNS,
